...
var testArr = [
  ...
  [
    ...
    [{"id":"7e55ee16fc20cbd63a6a3b7e1c013f97","name":"http://schema.org/LocalBusiness","properties":{"name":"Beachwalk Beachwear & Giftware","description":"A superb collection of fine gifts and clothing to accent your stay in Mexico Beach.","address":"3102 Highway 98 Mexico Beach, FL","telephone":"850-648-4200"}},{"id":"88503ff3d5d725b6b885fbfbabb9dc52","name":"http://schema.org/PostalAddress","properties":{"streetAddress":"3102 Highway 98","addressLocality":"Mexico Beach","addressRegion":"FL"}}]
  ],
  [
    'Person',
    'https://raw.github.com/mhausenblas/schema-org-rdf/master/examples/Thing/Person/Person.microdata',
    [{"id":"5422357c8aa8619418cccf9023c4477d","name":"http://schema.org/Person","properties":{"name":"Jane Doe","image":"janedoe.jpg","jobTitle":"Professor","address":"20341 Whitworth Institute 405 N. Whitworth Seattle, WA 98052","telephone":"(425) 123-4567","email":"jane-doe@xyz.edu","url":"janedoe.com","colleagues":"Bob Smith"}},{"id":"5832e50426b3f1acd4219e94f9b96495","name":"http://schema.org/PostalAddress","properties":{"streetAddress":"20341 Whitworth Institute 405 N. Whitworth","addressLocality":"Seattle","addressRegion":"WA","postalCode":"98052"}}]
  ]
]
...
testArr.forEach(function(arr) {
  ...
  describe(test_name+' json md5', function(){
    it('should match '+md5(expected), function(done) {
      microdata.parseUrl(url, function(err, json) {
        assert.equal(json.length, JSON.stringify(expected).length);
        assert.equal(md5(json), md5(JSON.stringify(expected)));
        done();
      });
    })
  })
